...
interface BuildExtensionContextParams {
  ...
  locale: McapViewerExtensionContext['locale'];
  theme: McapViewerExtensionContext['theme'];
  hostContext?: unknown;
...
export function buildExtensionContext(params: BuildExtensionContextParams): McapViewerExtensionContext {
  return {
