...
import type { McapViewerLanguageCode, McapViewerUiTheme } from '@/core/preferences/types';
...
export interface McapViewerExtensionContext {
...
export interface SidebarTabContribution {
  ...
  icon?: ReactNode;
  order?: number;
  render: (context: McapViewerExtensionContext) => ReactNode;
}
...
export interface McapViewerExtension {
  id: string;
