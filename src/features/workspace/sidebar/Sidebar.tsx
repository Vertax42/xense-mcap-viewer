...
import type { McapViewerExtension, McapViewerExtensionContext, SidebarTabContribution } from '@/core/extensions/types';
...
interface SidebarProps {
  ...
  extensionContext: McapViewerExtensionContext;
