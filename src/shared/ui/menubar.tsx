...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn("flex h-9 items-center gap-1 rounded-md border border-transparent bg-transparent p-0", className)}
    {...props}
  />
))
...
>(({ className, align = "start", alignOffset = -4, sideOffset = 6, ...props }, ref) => (
  <MenubarPrimitive.Portal container={getXenseViewerPortalRoot()}>
